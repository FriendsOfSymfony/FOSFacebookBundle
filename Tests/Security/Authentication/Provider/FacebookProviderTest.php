...
class FacebookProviderTest extends \PHPUnit_Framework_TestCase
{
  ...
  public function testThatUserCheckerCannotBeNullWhenUserProviderIsNotNull( )
  {
    ...
    new FacebookProvider( 'main', $facebookMock,
  ...
  public function testThatCannotAuthenticateWhenTokenIsNotFacebookUserToken( )
  {
    ...
    $this
        ->assertNull( 
            $facebookProvider
                ->authenticate( $this->getMock( 'Symfony\Component\Security\Core\Authentication\Token\TokenInterface' ) ) );
  }
  ...
  public function testThatCannotAuthenticateWhenTokenFromOtherFirewall( )
  {
    ...
    $tokenMock = $this
        ->getMock( 'FOS\FacebookBundle\Security\Authentication\Token\FacebookUserToken', array( 'getProviderKey' ),
            array( $providerKeyForToken ) );
    $tokenMock->expects( $this->any( ) )->method( 'getProviderKey' )->will( $this->returnValue( $providerKeyForToken ) );
  ...
  public function testThatCanAuthenticateUserWithoutUserProvider( )
  {
    ...
    $facebookMock = $this->getMockBuilder( 'FOS\FacebookBundle\Facebook\FacebookSessionPersistence' )
        ->disableOriginalConstructor( )->setMethods( array( 'getUser' ) )->getMock( );
    ...
    $tokenMock = $this
        ->getMock( 'FOS\FacebookBundle\Security\Authentication\Token\FacebookUserToken',
            array( 'getAttributes', 'getProviderKey' ), array( $providerKey ) );
  ...
  public function testThatCannotAuthenticateWhenUserProviderThrowsAuthenticationException( )
  {
    ...
    $userProviderMock->expects( $this->once( ) )->method( 'loadUserByUsername' )->with( '123' )
  ...
  public function testThatCannotAuthenticateWhenCannotRetrieveFacebookUserFromSession( )
  {
    ...
    $facebookMock = $this->getMockBuilder( 'FOS\FacebookBundle\Facebook\FacebookSessionPersistence' )
        ->disableOriginalConstructor( )->setMethods( array( 'getUser' ) )->getMock( );
    $facebookMock->expects( $this->once( ) )->method( 'getUser' )->will( $this->returnValue( false ) );
